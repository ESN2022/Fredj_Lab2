...
int main()
{ 
	alt_ic_isr_register(TIMER_0_IRQ_INTERRUPT_CONTROLLER_ID,TIMER_0_IRQ, (void*)irqhandler_TIMER_0, NULL, 0);// to register the interruption
